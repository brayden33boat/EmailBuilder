...
export class WidgetsService {
  ...
  getWidgets(){
    ...
    widgets.push(new Widget(10,"Single Link",5,"fa fa-link fa-4", templates.template12, [{ 'label':'Alignment', 'selector': 'align', 'value': 'center' },{ 'label':'Link', 'selector': 'href', 'value': '#' },{ 'label':'Link Text', 'selector': 'linkText', 'value': 'link' }]));
    widgets.push(new Widget(11,"Two Links", 5,"fa fa-link fa-4", templates.template13, [{ 'label':'Alignment', 'selector': 'align', 'value': 'center' },{ 'label':'1st href', 'selector': 'href1', 'value': '#' },{ 'label':'1st Link Text', 'selector': 'linkText1', 'value': 'link' },{ 'label':'2nd Link', 'selector': 'href2', 'value': '#' },{ 'label':'2nd Link Text', 'selector': 'linkText2', 'value': 'link' }]));

    widgets.push(new Widget(12,"Single Button",6,"fa fa-share-square fa-4", templates.template14, [{ 'label':'Alignment', 'selector': 'align', 'value': 'center' },{ 'label':'Link', 'selector': 'href', 'value': '#' },{ 'label':'Link Text', 'selector': 'linkText', 'value': 'link' },{'label':'Background Color', 'selector':'bgColor1', 'value':'orange'}]));
