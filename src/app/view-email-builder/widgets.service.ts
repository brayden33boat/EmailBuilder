...
export class WidgetsService {
  ...
  getWidgets(){
    ...
    widgets.push(new Widget(6,3,"fa fa-address-card-o fa-flip-horizontal fa-6", "<table style='width:100%'><tr align='center'><td style='width:50%'><p>{{text}}</p></td><td style='width:50%'><img width='100%' src='{{img}}' /></td></tr></table>", [{ 'selector': 'text', 'value': 'text' },{'selector':'img','value':'http://www.lijsoccer.com/images/soccerBall.png'}]));
    widgets.push(new Widget(7,3,"fa fa-address-card-o fa-6", "<table style='width:100%'><tr align='center'><td style='width:50%'><img width='100%' src='{{img}}' /></td><td style='width:50%'><p>{{text}}</p></td></tr></table>", [{ 'selector': 'text', 'value': 'text' },{'selector':'img','value':'http://www.lijsoccer.com/images/soccerBall.png'}]));
