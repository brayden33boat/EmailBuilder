...
export class WidgetsService {
  ...
  getWidgets(){
    ...
    widgets.push(new Widget(11,"Two Links", 5,"fa fa-link fa-4", templates.template13, [{ 'label':'Alignment', 'selector': 'align', 'value': 'center' },{ 'label':'1st href', 'selector': 'href1', 'value': '#' },{ 'label':'1st Link Text', 'selector': 'linkText1', 'value': 'link' },{ 'label':'Second Link URL', 'selector': 'href2', 'value': '#' },{ 'label':'Second Link Text', 'selector': 'linkText2', 'value': 'link' }]));
    ...
    widgets.push(new Widget(13,"Two Buttons",6,"fa fa-share-square fa-4", templates.template15, [{ 'label':'Alignment','selector': 'align', 'value': 'center' },{ 'label':'1st link URL','selector': 'href1', 'value': '#' },{'label':'1st Link Text', 'selector': 'linkText1', 'value': 'link' },{ 'label':'Second Link URL', 'selector': 'href2', 'value': '#' },{ 'label':'Second Link Text', 'selector': 'linkText2', 'value': 'link' },{'label':'First Background Color','selector':'bgColor1', 'value':'orange'}, {'label':'Second Background Color','selector':'bgColor2', 'value':'orange'}]));
