...
export class WidgetsService {
  ...
  getWidgets(){
    ...
    widgets.push(new Widget(7,3,"fa fa-picture-o fa-6", "<table style='width:100%'><tr align='{{align}}'><td style='width:50%'><img width='200px' src='{{img1}}' /></td><td style='width:50%'><img width='200px' src='{{img2}}' /></td></tr></table>", [{'label':'Img Url', 'selector':'img1','value':'https://saffadesign.files.wordpress.com/2014/11/placeholder.jpg'},{'label':'Img Url', 'selector':'img2','value':'https://saffadesign.files.wordpress.com/2014/11/placeholder.jpg'},{ 'label':'Alignment', 'selector': 'align', 'value': 'center' }]));
